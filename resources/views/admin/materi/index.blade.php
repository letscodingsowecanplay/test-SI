...
@section('content')
    {{-- Penjelasan Audio untuk Anak SD --}}
    <div class="alert alert-warning mb-3" style="font-size: 1.05rem;">
        <b>Petunjuk:</b> Kalau kamu ingin mendengar kalimatnya, tekan tombol <span style="font-size:1.2em;">🔊</span> yang ada di sebelah tulisan. Nanti akan ada suara yang membacakan materi untukmu! <button onclick="toggleAudio(this)" 
    ...
    <div class="card bg-coklat">
        ...
        <div class="card-footer text-end">
            <a href="{{ route('admin.materi.halaman2') }}" class="btn bg-coklap1 text-white">Selanjutnya →</a>
        </div>
    </div><br>
@endsection
